...
export default function LoginPage({
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (onNavigateToHome) {
        ...
        // Beri tahu App state supaya header berubah
        window.dispatchEvent(new Event("storage"));

        // Pindah halaman ke landing
        onNavigateToHome();
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col items-center justify-start lg:justify-center px-6 py-16 lg:px-[64px] lg:w-auto lg:min-w-[590px] order-2 lg:order-2 overflow-y-auto"
        style={{ backgroundColor: semanticColors.bgPrimary }}
      >
