...
export default function LandingPage({ onNavigateToLogin, onNavigateToSignUp, onNavigateToDetailKios }: LandingPageProps) {
  // Category filters with icon colors (for chip selector)
  const categories = [
    { id: 'all', label: 'Tampilkan Semua', icon: faUtensils, iconColor: semanticColors.textPrimary },
    { id: 'featured', label: 'Pilihan Kami', icon: null, iconColor: colors.secondary[500], useCheckBadge: true }, // Uses CheckBadgeIcon
    { id: 'halal', label: 'Halal', icon: null, iconColor: undefined, useHalalIcon: true }, // Uses HalalIcon component
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (lihatSemuaRef.current && !lihatSemuaRef.current.contains(event.target as Node)) {
  ...
  const kiosData = [
    {
      id: 1,
      image: 'https://images.unsplash.com/photo-1634871572365-8bc444e6faea?w=574&h=386&fit=crop&q=80&auto=format',
    ...
    {
      id: 2,
      image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=574&h=386&fit=crop&q=80&auto=format',
      name: 'Kedai Salad Sehat',
      description: 'Kedai sehat yang fokus menyajikan makanan bergizi dan rendah kalori. Tempat favorit bagi yang ingin menjaga pola makan sehat tanpa mengorbankan rasa.',
    ...
    {
      id: 3,
      image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=574&h=386&fit=crop&q=80&auto=format',
      name: 'Pizzeria Italia Nusantara',
      description: 'Restoran pizza dengan sentuhan lokal Indonesia. Menghadirkan pizza dengan topping unik yang menggabungkan cita rasa Italia dan Indonesia.',
      categories: 'Makanan',
      location: 'Bandung',
      rating: 4.5,
    ...
    {
      id: 4,
      image: 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=574&h=386&fit=crop&q=80&auto=format',
      name: 'Toko Kue Premium',
      description: 'Toko kue spesialis kue premium dan pastry berkualitas tinggi. Menggunakan bahan-bahan pilihan dan teknik pembuatan yang teliti untuk hasil yang sempurna.',
      categories: 'Dessert',
      location: 'Surabaya',
      rating: 4.2,
    ...
    {
      id: 5,
      image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=574&h=386&fit=crop&q=80&auto=format',
      name: 'Cafe Brunch Favorit',
      description: 'Cafe cozy yang terkenal dengan menu brunch dan breakfast yang lengkap. Suasana nyaman dan hangat, cocok untuk bersantai bersama keluarga atau teman.',
      categories: 'Dessert',
      location: 'Yogyakarta',
      rating: 4.8,
    ...
    {
      id: 6,
      image: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=574&h=386&fit=crop&q=80&auto=format',
      name: 'Ramen House Asia',
      description: 'Restoran ramen autentik dengan berbagai varian ramen dari berbagai negara Asia. Kuah yang kaya rasa dan bahan-bahan segar setiap harinya.',
      categories: 'Makanan',
      location: 'Medan',
      rating: 4.6,
    ...
    {
      id: 7,
      image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=574&h=386&fit=crop&q=80&auto=format',
      name: 'Burger Joint Klasik',
      description: 'Tempat makan burger dengan konsep klasik Amerika. Burger dengan patty tebal, keju leleh, dan bahan-bahan segar yang membuat setiap gigitan memuaskan.',
      categories: 'Makanan',
      location: 'Denpasar',
      rating: 4.9,
    ...
    {
      id: 8,
      image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=574&h=386&fit=crop&q=80&auto=format',
      name: 'Rumah Makan Nusantara',
      description: 'Rumah makan yang menghadirkan berbagai hidangan nusantara dalam satu tempat. Dari ayam goreng, daging bakar, hingga urap sayuran, semua tersedia di sini.',
      categories: 'Makanan, Nusantara',
      location: 'Makassar',
      rating: 4.3,
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-2 sm:gap-4 lg:pb-2 pb-0">
            ...
            <div className="flex lg:hidden gap-2 sm:gap-4">
              ...
              <div className="relative flex-1" ref={lihatSemuaRef}>
                ...
                >
                  <span className="font-dm-sans font-regular text-sm">Jenis Produk</span>
                  <FontAwesomeIcon 
                    icon={faChevronDown} 
                    className={`w-4 h-4 transition-transform ${lihatSemuaDropdown ? 'rotate-180' : ''}`} 
                  />
                </button>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            {cat.useHalalIcon ? (
                              ...
                              <CheckBadgeIcon width={16} height={16} color={cat.iconColor || semanticColors.textPrimary} />
                            ) : cat.icon ? (
                              <FontAwesomeIcon
                                icon={cat.icon}
                                className="w-4 h-4"
                ...
                <ChipSelector
                  ...
                  icon={
                    cat.useHalalIcon ? (
                      ...
                      <CheckBadgeIcon width={20} height={20} color={cat.iconColor || semanticColors.textPrimary} />
                    ) : cat.icon ? (
            ...
            <div className="hidden lg:flex gap-4 items-center shrink-0">
              ...
              <div className="relative" ref={lihatSemuaRef}>
                ...
                >
                  <span className="font-dm-sans font-regular text-sm">Lihat Semua</span>
                  <FontAwesomeIcon 
                    icon={faChevronDown} 
                    className={`w-4 h-4 transition-transform ${lihatSemuaDropdown ? 'rotate-180' : ''}`} 
                  />
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[30px] mb-8">
            {kiosData.map((kios, index) => (
              <KiosCard
                ...
                onClick={index === 0 ? onNavigateToDetailKios : () => console.log('View kios', kios.id)}
              />
            ))}
          </div>
          ...
          <div className="flex justify-center">
            <Button
              ...
              rightIcon={<FontAwesomeIcon icon={faChevronRight} className="w-4 h-4" />}
              className="px-8"
            >
