...
import { Header, Footer, Button, TextField, Input, Select, ChipSelector, HalalIcon } from '../components';
...
export default function SettingsPage({
  ...
  const [kiosDescription, setKiosDescription] = useState('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');
  const [selectedJenisProduk, setSelectedJenisProduk] = useState<string[]>(['food', 'nusantara']); // Array of selected category IDs
  ...
  const kiosAddress = 'Jalan Kutai Utara Nomor 1, Kelurahan Sumber, Kecamatan Banjarsari, Kota Solo, Jawa Tengah.';
  ...
  const jenisProdukOptions = [
    ...
    { id: 'nusantara', label: 'Nusantara', icon: faBowlRice, iconColor: semanticColors.textPrimary },
    ...
    { id: 'halal', label: 'Halal', icon: null, iconColor: undefined, useHalalIcon: true },
  ];

  const handleJenisProdukToggle = (categoryId: string) => {
    if (selectedJenisProduk.includes(categoryId)) {
      setSelectedJenisProduk(selectedJenisProduk.filter(id => id !== categoryId));
    } else {
  ...
  const [products, setProducts] = useState([
    { id: 1, image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=287&h=193&fit=crop', name: 'Sate Ayam', price: '20000' },
    { id: 2, image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=287&h=193&fit=crop', name: 'Sate Kambing', price: '25000' },
  ]);
  ...
  const handleAddKiosImage = () => {
    if (kiosImages.length < 3) {
      setKiosImages([...kiosImages, 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=287&h=193&fit=crop']);
    }
  };
  ...
  const handleAddProductImage = (id: number) => {
    ...
    setProducts(products.map(p => p.id === id ? { ...p, image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=287&h=193&fit=crop' } : p));
  };
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: colors.neutral[3] }}>
      ...
      <section className="px-4 sm:px-6 lg:px-20 py-6 flex-1">
        <div className="max-w-[1440px] mx-auto flex flex-col gap-4">
          ...
          >
            {/* Section Title */}
            <div className="flex flex-col gap-3 pb-3 border-b" style={{ borderColor: colors.neutral[6] }}>
              <h1
            ...
            {/* Profile Picture */}
            <div className="flex flex-col sm:flex-row gap-4 items-center pb-4 border-b" style={{ borderColor: colors.neutral[6] }}>
              <div className="relative rounded-full shrink-0" style={{ width: '96px', height: '96px' }}>
                {profileImage ? (
                  <img
                    src={profileImage}
                    alt="Profile"
              ...
              <div className="flex flex-col gap-0.5 flex-1 w-full sm:w-auto text-center sm:text-left">
                <p className="font-dm-sans font-bold text-sm" style={{ color: semanticColors.textPrimary }}>
                  Gambar Profil
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <Button variant="primary" onClick={() => console.log('Upload image')} className="w-full sm:w-auto">
                  Upload Gambar Baru
                </Button>
                <Button variant="secondary" onClick={() => setProfileImage(undefined)} className="w-full sm:w-auto">
                  Hapus
                </Button>
              </div>
            </div>
            ...
            {/* Nama Akun */}
            <div className="flex flex-col gap-3 pb-4 border-b" style={{ borderColor: colors.neutral[6] }}>
              <h2 className="font-dm-sans font-bold text-lg" style={{ color: semanticColors.textPrimary }}>
                Nama Akun
              </h2>
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex flex-col gap-1.5 flex-1">
                  <label className="font-dm-sans font-bold text-sm" style={{ color: semanticColors.textPrimary }}>
                    Nama Depan
                  </label>
                  <TextField
                    value={namaDepan}
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-4 items-end">
                ...
                <Button variant="primary" onClick={() => console.log('Update password')} className="w-full sm:w-auto">
                  Update Password
                </Button>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex flex-col gap-3 pb-4 border-b" style={{ borderColor: colors.neutral[6] }}>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {kiosImages.map((image, index) => (
                    <div key={index} className="relative w-full sm:w-[287px] h-[193px] rounded-[12px] overflow-hidden">
                      <img
                        src={image}
                        alt={`Kios ${index + 1}`}
                      ...
                      <button
                        ...
                        style={{ backgroundColor: semanticColors.bgPrimary }}
                      >
                        <FontAwesomeIcon icon={faTimes} className="w-5 h-5" style={{ color: semanticColors.textPrimary }} />
                      </button>
                    </div>
                  ))}
                  {kiosImages.length < 3 && (
                    <button
                      ...
                      onMouseEnter={(e) => e.currentTarget.style.backgroundColor = colors.neutral[7]}
                      onMouseLeave={(e) => e.currentTarget.style.backgroundColor = colors.neutral[6]}
                    >
                      <div className="flex items-center justify-center p-2.5 rounded-full" style={{ backgroundColor: semanticColors.bgPrimary }}>
                        <FontAwesomeIcon icon={faPlus} className="w-5 h-5" style={{ color: semanticColors.textPrimary }} />
                      </div>
                    </button>
                  )}
                </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex flex-col gap-1.5 items-end">
                  ...
                  />
                  <p className="font-dm-sans font-regular text-xs" style={{ color: semanticColors.textSecondary }}>
                    Maksimal 200 Huruf, {descriptionCharCount}/{maxChars} digunakan
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="h-[273px] rounded-[12px] border-2 overflow-hidden" style={{ borderColor: colors.neutral[6] }}>
            ...
            <div className="flex flex-col gap-3">
              ...
              {products.map((product) => (
                <div key={product.id} className="flex flex-col sm:flex-row gap-4 items-end pb-16 md:pb-0">
                  <div className="relative w-full sm:w-[105.58px] h-[71px] rounded-[4.415px] overflow-hidden shrink-0">
                    {product.image ? (
                      ...
                      <button
                        ...
                        onMouseLeave={(e) => e.currentTarget.style.backgroundColor = colors.neutral[6]}
                      >
                        <div className="flex items-center justify-center p-1.5 rounded-full" style={{ backgroundColor: semanticColors.bgPrimary }}>
                          <FontAwesomeIcon icon={faPlus} className="w-4 h-4" style={{ color: semanticColors.textPrimary }} />
                        </div>
                      </button>
                    )}
                  </div>
                  <div className="flex flex-col sm:flex-row gap-4 flex-1 w-full">
                    ...
                    <div className="flex flex-col gap-1.5 flex-1">
                      ...
                      <TextField
                        value={product.price === '0' ? '' : `Rp ${parseInt(product.price).toLocaleString('id-ID')}`}
                        onChange={(e) => {
                          const numericValue = e.target.value.replace(/[^\d]/g, '');
                          setProducts(products.map(p => p.id === product.id ? { ...p, price: numericValue } : p));
                        }}
                  ...
                  <div className="flex gap-2 shrink-0 w-full sm:w-auto" ref={updateHapusContainerRef}>
                    <Button variant="primary" onClick={() => handleUpdateProduct(product.id)} className="flex-1 sm:flex-none">
                      Update
                    </Button>
                    <Button variant="secondary" onClick={() => handleRemoveProduct(product.id)} className="flex-1 sm:flex-none">
                      Hapus
                    </Button>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-end">
                ...
                <div className="flex gap-2 shrink-0 w-full sm:w-auto" ref={tambahProdukContainerRef}>
                  <Button variant="primary" onClick={handleAddProduct} className="w-full">
                    Tambah Produk
                  </Button>
                </div>
              </div>
